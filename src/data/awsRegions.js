const regions = {
  ...
  za: [{ name: 'af-south-1', niceName: 'Cape Town' }],
  hk: [{ name: 'ap-east-1', niceName: 'Hong Kong' }],
  in: [{ name: 'ap-south-1', niceName: 'Mumbai' }],
  jp: [
    { name: 'ap-northeast-3', niceName: 'Osaka-Local' },
    { name: 'ap-northeast-1', niceName: 'Tokyo' },
  ],
